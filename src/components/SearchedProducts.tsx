...
export const SearchedProducts = ({ query }: Props) => {
  ...
  return (
    <m.div
      ...
      className="max-w-md max-h-80 scroll-small overflow-y-auto absolute top-12 sm:top-16 left-0.5 right-0.5 mr-auto ml-auto rounded-md p-2 bg-gray border-2 border-light-gray z-30"
    >
